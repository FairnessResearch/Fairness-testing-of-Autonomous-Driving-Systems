...
csv_adult = r"/Users/xinyueli/Desktop/Research/fairness-testing/evaluation/scripts/evaluation/fig3/adult_labels.csv"
csv_child = r"/Users/xinyueli/Desktop/Research/fairness-testing/evaluation/scripts/evaluation/fig3/child_labels.csv"
...
plt.title("Adult and Child \nDistribution",fontdict={'fontweight':'bold','fontsize':15})
# Set the legend
plt.legend(loc='lower right', prop = {'weight':'bold'}, fontsize = 13)
# Load the data for the second plot
csv_detected = r"/Users/xinyueli/Desktop/Research/fairness-testing/evaluation/scripts/evaluation/fig3/detected.csv"
csv_miss = r"/Users/xinyueli/Desktop/Research/fairness-testing/evaluation/scripts/evaluation/fig3/undetected.csv"
...
ax1.set_xlabel('Width', fontweight='bold', fontsize = 13)
ax1.set_ylabel('Height', fontweight='bold', fontsize = 13)
ax2.set_xlabel('Width', fontweight='bold', fontsize = 13)
ax2.set_ylabel('Height', fontweight='bold', fontsize = 13)

ax1.set_xticklabels(ax1.get_xticklabels(), fontdict = {'weight':'bold','fontsize':13})
ax1.set_yticklabels(ax1.get_yticklabels(), fontdict = {'weight':'bold','fontsize':13})
ax2.set_xticklabels(ax2.get_xticklabels(), fontdict = {'weight':'bold','fontsize':13})
ax2.set_yticklabels(ax2.get_yticklabels(), fontdict = {'weight':'bold','fontsize':13})
